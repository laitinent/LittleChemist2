...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setCustomAdapter(images, false, toolBox2)
        ...
        //val palette = findViewById<RecyclerView>(R.id.recyclerToolView)
        //palette.minimumHeight = shape.height.roundToInt()*2

        //setTouchListenetToApp(shape)
    ...
    private fun setCustomAdapter(images: Array<ToolBoxItem2>, enable:Boolean, toolBox2: RecyclerView) {
        mAdapter = CustomAdapter(images,enable) //TODO:
        {  // this is ClickListener
...
// Give the RecyclerView a default layout manager.
    ...
    private fun setTouchListenetToApp(shape: OvalShape) {
